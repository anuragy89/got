...
THEMES = {
    ...
    "medicine": {
        "name": "Medicine", "emoji": "🏥",
        "words": [
            "VEIN","BONE","SKIN","GERM","CYST","DOSE","DRUG","WARD","SCAN","XRAY",
            "PULSE","FEVER","TONIC","SERUM","TUMOR","ORGAN","NURSE","LIVER","HEART",
            "SEPSIS","ASTHMA","UROLOGY","SURGERY","SYMPTOM","DISEASE","VACCINE","CAPSULE",
            "THERAPY","INSULIN","ANATOMY","BLADDER","CALCIUM","HORMONE","GLUCOSE","THYROID",
            "CORNEA","RETINA","ARTERY","PLASMA","SPLEEN","KIDNEY","NEURON","TENDON",
            "MUSCLE","PELVIS","CORTEX","TONSIL","BRONCHI","OVARY","MARROW","SALIVA",
            "CARDIOLOGY","NEUROLOGY","ONCOLOGY","PEDIATRICS","PSYCHIATRY","PATHOLOGY",
            "RADIOLOGY","NEPHROLOGY","HEMATOLOGY","IMMUNOLOGY","ANESTHESIA","EMERGENCY",
            "ANTIBIOTIC","ANTIVIRAL","ANALGESIC","STETHOSCOPE","ENDOSCOPE","DIAGNOSIS",
            "PROGNOSIS","INFECTION","DIABETES","EPILEPSY","ALZHEIMER","PARKINSON",
        ],
        "bg":          (0, 26, 20),
        "header_bg":   (0, 18, 14),
        "cell_bg":     (0, 36, 28),
    ...
    "psychology": {
        ...
        "words": [
            "OCD","PTSD","ADHD","MOOD","MIND","SELF","RAGE","FEAR","GRIEF","STRESS",
            "ANGER","SHAME","GUILT","TRUST","PANIC","DREAM","SLEEP","WILL","DRIVE","NEED",
            "MEMORY","TRAUMA","PHOBIA","DENIAL","BIPOLAR","ANXIETY","EMPATHY","INSIGHT",
            "BONDING","RAPPORT","EMOTION","MOTIVE","AUTISM","COGNITION","LEARNING","THERAPY",
            "DEPRESSION","NARCISSISM","REPRESSION","SUBLIMATION","DISPLACEMENT","REGRESSION",
            "SCHIZOPHRENIA","PERSONALITY","PERCEPTION","ATTENTION","MOTIVATION","SYMPATHY",
            "CLASSICAL","OPERANT","COGNITIVE","BEHAVIORAL","HUMANISTIC","GESTALT","NARRATIVE",
    ...
    "dinosaurs": {
        ...
        "words": [
            "TREX","CLAW","FANG","BONE","NEST","HERD","MASS","PREY","HORN","TAIL",
            "SCALE","SKULL","SPINE","FOSSIL","RAPTOR","THEROPOD","JURASSIC","TRIASSIC",
            "VELOCIRAPTOR","TRICERATOPS","STEGOSAURUS","ANKYLOSAURUS","SPINOSAURUS","ALLOSAURUS",
            "DIPLODOCUS","APATOSAURUS","BRONTOSAURUS","IGUANODON","HADROSAUR","PTEROSAUR",
            "PTERODACTYL","PTERANODON","PLESIOSAUR","MOSASAUR","ICHTHYOSAUR","NOTHOSAUR",
            "CRETACEOUS","DEVONIAN","SILURIAN","PERMIAN","EXTINCTION","METEORITE","IRIDIUM",
            "PALEONTOLOGY","EXCAVATION","CERATOPSIAN","SAUROPODA","PROTOCERATOPS","STYRACOSAURUS",
        ],
        "bg":          (10, 24, 0),
        "header_bg":   (14, 36, 0),
        "cell_bg":     (12, 30, 2),
    ...
    "ocean3": {
        ...
        "words": [
            "TANG","GOBY","REEF","KELP","TIDE","WAVE","CRAB","GILL","VENT","DEEP",
            "MAJOR","CORAL","ALGAE","SPAWN","SHOAL","WRASSE","BRINE","ABYSS","GROTTO","ATOLL",
            "CLOWNFISH","ANGELFISH","TRIGGERFISH","LIONFISH","SEAHORSE","PIPEFISH","PUFFERFISH",
            "BLOWFISH","FILEFISH","SURGEONFISH","PARROTFISH","DAMSELFISH","CHROMIS","DOTTYBACK",
            "BLENNY","MANDARIN","FLATHEAD","STARGAZER","LIZARDFISH","TOADFISH","FROGFISH",
            "GURNARD","BOXFISH","COWFISH","HOGFISH","TUSKFISH","SERGEANT","BASSLET","TRUNKFISH",
        ],
        "bg":          (0, 22, 36),
        "header_bg":   (0, 32, 50),
        "cell_bg":     (0, 28, 46),
    ...
    "dinosaurs2": {
        ...
        "words": [
            "TUSK","CAVE","FANG","HIDE","HORN","MANE","CLAW","PELT","PREY","PACK",
            "HERD","TRAP","MIRE","SWAMP","BEAST","EPOCH","FAUNA","FLORA","AMBER","LARVA",
            "MASTODON","GLYPTODON","MEGALODON","COELACANTH","DORUDON","ZEUGLODON","MIACID",
            "SABERTOOTH","MEGATHERIUM","DUNKLEOSTEUS","HELICOPRION","DIMORPHODON","PTERANODON",
            "AMBULOCETUS","PAKICETUS","BASILOSAURUS","KRONOSAURUS","LIOPLEURODON","PLESIOSAURUS",
            "THYLACOSMILUS","ANDREWSARCHUS","BRONTOTHERIUM","UINTATHERIUM","ANOMALOCARIS","OPABINIA",
        ],
        "bg":          (18, 24, 0),
        "header_bg":   (26, 36, 0),
        "cell_bg":     (22, 30, 2),
    ...
    # ── 5 ADDITIONAL NEW THEMES ───────────────────────────────────

    "street_food": {
        "name": "Street Food", "emoji": "🌮",
        "words": [
            "SAMOSA","VADA","PAV","BHAJI","CHAAT","GOLGAPPA","PUCHKA","BHELPURI","SEVPURI",
            "DAHI","PAPDI","RAGDA","ALOO","TIKKI","KACHORI","JALEBI","IMARTI","RABRI",
            "PANI","PURI","MOMOS","THUKPA","CHURMURI","MIRCHI","BONDA","BAJJI","PUNUGULU",
            "SUNDAL","MURUKKU","KAVUNI","TAPIOCA","MASALA","CHAI","KULHAD","LASSI","SHIKANJI",
            "TACO","BURRITO","ELOTE","CHURROS","TAMALE","QUESADILLA","SOPE","HUARACHE",
            "BAOZI","JIANBING","ROUJIAMO","TANGHULU","STINKYTOFU","OYSTER","VERMICELLI",
            "TAKOYAKI","OKONOMIYAKI","TAIYAKI","YAKITORI","ONIGIRI","IKAYAKI","YAKISOBA",
            "SHAWARMA","FALAFEL","HALLOUMI","KNAFEH","MANAKEESH","SFIHA","LAHM","BAAJIN",
            "GOZLEME","MIDYE","KOKOREC","SIMIT","KUMPIR","BALIK","EKMEK","ISLAK","BURGER",
        ],
        "bg":          (32, 8, 0),
        "header_bg":   (50, 12, 0),
        "cell_bg":     (40, 10, 2),
        "cell_border": (150, 50, 12),
        "accent":      (253, 186, 116),
        "letter":      (255, 240, 210),
        "sub":         (246, 196, 130),
    },
    "cats_dogs": {
        "name": "Cats & Dogs", "emoji": "🐱",
        "words": [
            "PERSIAN","SIAMESE","BENGAL","RAGDOLL","MAINE","COON","SPHYNX","ABYSSINIAN",
            "BURMESE","BIRMAN","TONKINESE","SIBERIAN","NORWEGIAN","TURKISH","ANGORA","DEVON",
            "CORNISH","REX","SCOTTISH","FOLD","MUNCHKIN","SAVANNAH","CHAUSIE","BOMBAY",
            "LABRADOR","GOLDEN","RETRIEVER","BULLDOG","POODLE","BEAGLE","ROTTWEILER",
            "YORKSHIRE","TERRIER","DACHSHUND","BOXER","HUSKY","DOBERMAN","SHIBA","INU",
            "CHIHUAHUA","MALTESE","POMERANIAN","CORGI","COLLIE","DALMATIAN","SPANIEL",
            "SCHNAUZER","AKITA","SAMOYED","MALAMUTE","WEIMARANER","VIZSLA","BRACCO",
            "PURRING","MEOWING","HISSING","GROOMING","KNEADING","SCRATCHING","FETCHING",
            "BARKING","HOWLING","WAGGING","PAWING","SNIFFING","DIGGING","HERDING","GUARDING",
        ],
        "bg":          (24, 14, 0),
        "header_bg":   (38, 20, 0),
        "cell_bg":     (30, 16, 2),
        "cell_border": (120, 70, 16),
        "accent":      (251, 191, 36),
        "letter":      (255, 248, 215),
        "sub":         (240, 205, 110),
    },
    "emojis": {
        "name": "Emoji & Internet", "emoji": "😂",
        "words": [
            "TRENDING","VIRAL","MEME","HASHTAG","REPOST","SHARE","REACT","COMMENT",
            "FOLLOWER","SUBSCRIBER","INFLUENCER","CONTENT","CREATOR","STREAMER","VLOGGER",
            "PODCAST","THUMBNAIL","CLICKBAIT","ALGORITHM","MONETIZE","SPONSOR","COLLAB",
            "ROFL","LMAO","AFAIK","FOMO","YOLO","GOAT","SALTY","SHOOK","LOWKEY","HIGHKEY",
            "VIBE","SLAY","BUSSIN","RIZZ","SIGMA","BASED","CRINGE","RATIO","GHOSTED","SIMP",
            "SUS","NPC","GIGACHAD","COPIUM","HOPIUM","TOUCH","GRASS","SKILL","ISSUE","SHEESH",
            "SELFIE","BOOMERANG","REEL","STORY","HIGHLIGHT","CLOSE","FRIENDS","FINSTA",
            "TWITTER","REDDIT","DISCORD","TWITCH","TIKTOK","YOUTUBE","INSTAGRAM","SNAPCHAT",
        ],
        "bg":          (14, 4, 28),
        "header_bg":   (22, 6, 42),
        "cell_bg":     (18, 6, 36),
        "cell_border": (72, 22, 120),
        "accent":      (232, 121, 249),
        "letter":      (252, 232, 255),
        "sub":         (235, 170, 250),
    },
    "supervillains": {
        "name": "Villains & Bosses", "emoji": "😈",
        "words": [
            "JOKER","THANOS","MAGNETO","LOKI","VENOM","CARNAGE","GOBLIN","ELECTRO",
            "VULTURE","RHINO","SANDMAN","SHOCKER","MYSTERIO","CHAMELEON","KINGPIN","BULLSEYE",
            "ARES","ENCHANTRESS","HELA","SURTUR","DORMAMMU","MEPHISTO","GALACTUS","ULTRON",
            "KANG","MOLECULE","MANDARIN","CRIMSON","DYNAMO","MORBIUS","JACKAL","OCTAVIUS",
            "DOOM","DIABLO","ATTUMA","NAMOR","JUGGERNAUT","ABOMINATION","LEADER","ZEMO",
            "MODOK","TASKMASTER","CROSSBONES","GHOST","YELLOWJACKET","WHIPLASH","ALDRICH",
            "DARKSEID","BRAINIAC","SINESTRO","BLACKMANTA","CHEETAH","ICICLE","GRODD",
            "PENGUIN","RIDDLER","BANE","SCARECROW","HARLEQUIN","CLAYFACE","FIREFLY","FREEZE",
        ],
        "bg":          (16, 0, 4),
        "header_bg":   (26, 0, 6),
        "cell_bg":     (22, 2, 8),
        "cell_border": (110, 8, 24),
        "accent":      (248, 68, 68),
        "letter":      (255, 228, 230),
        "sub":         (240, 150, 155),
    },
    "hindi_cinema": {
        "name": "Hindi Cinema", "emoji": "🎭",
        "words": [
            "AMITABH","SHAHRUKH","SALMAN","AAMIR","HRITHIK","RANVEER","RANBIR","AYUSHMANN",
            "DEEPIKA","PRIYANKA","KATRINA","ALIA","KANGANA","TAAPSEE","VIDYA","MADHURI",
            "SRIDEVI","HEMAMALINI","REKHA","ZEENAT","PARVEEN","DIMPLE","JAYA","SHABANA",
            "SHOLAY","DEEWAR","ZANJEER","AGNEEPATH","MUGHALAZAM","PAKEEZAH","GUIDE","TEESRI",
            "DILWALE","DDLJ","KKHH","MOHABBATEIN","LAGAAN","DEVDAS","SAATHIYA","YUVA",
            "GANGAAJAL","OMKARA","MAQBOOL","HAIDER","TALVAR","PINK","TOILET","BADHAAI",
            "ARTHDIRECTOR","CINEMATOGRAPHY","SCREENPLAY","DIALOGUES","STORYBOARD","DUBBING",
            "BACKGROUND","SCORE","CHOREOGRAPHY","PLAYBACK","SINGER","LYRICIST","COMPOSER",
        ],
        "bg":          (26, 10, 0),
        "header_bg":   (42, 16, 0),
        "cell_bg":     (34, 12, 2),
        "cell_border": (130, 56, 10),
        "accent":      (251, 146, 60),
        "letter":      (255, 238, 215),
        "sub":         (244, 185, 115),
    },
